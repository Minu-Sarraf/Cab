...
import com.cab.alington.cab.splashscreen.MathUtils;
...
public class RandomTransitiongenerator implements TransitionGenerator {
        ...
        public RandomTransitiongenerator(long transitionDuration, AccelerateDecelerateInterpolator transitionInterpolator) {
...
the last transition. */
            ...
            mLastGenTrans = new Transition(srcRect, dstRect, mTransitionDuration,
                    (android.view.animation.Interpolator) mTransitionInterpolator);
         ...
         */
        public void setTransitionInterpolator(AccelerateDecelerateInterpolator interpolator) {
