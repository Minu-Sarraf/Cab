package com.cab.alington.cab.splashscreen.datetime;

/**
 * Created by abc on 9/21/2016.
 */
...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate.setBackgroundColor(R.color.darkblue);
        ...
        btn_setTime.setBackgroundColor(R.color.darkblue);
        ...
        btn_set.setId(SET);
        btn_set.setTextColor(R.color.primary_darkGrey);
        ...
        btn_cancel.setTextColor(R.color.primary_darkGrey);
