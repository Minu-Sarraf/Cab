...
public class RoboTextView extends TextView {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        if (attrs == null) { //Not created from xml
            ...
            TypedArray values = getContext().obtainStyledAttributes(attrs, R.styleable.RoboTextView);
            typeface = values.getInt(R.styleable.RoboTextView_typeface, Roboto.ROBOTO_REGULAR);
            values.recycle();
        }
